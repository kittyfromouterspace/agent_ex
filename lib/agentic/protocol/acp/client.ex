defmodule Agentic.Protocol.ACP.Client do
  ...
  def handle_call({:request, method, params, timeout}, from, state) do
    ...
    msg =
      Agentic.Protocol.ACP.Types.build_request(id, method, params)
      |> Jason.encode!()
  ...
  def handle_cast({:notify, method, params}, state) do
    msg =
      Agentic.Protocol.ACP.Types.build_notification(method, params)
      |> Jason.encode!()
  ...
  defp dispatch_message(msg, state) do
    cond do
      Agentic.Protocol.ACP.Types.response?(msg) ->
        handle_response(msg, state)

      Agentic.Protocol.ACP.Types.notification?(msg) ->
        handle_notification(msg, state)

      Agentic.Protocol.ACP.Types.request?(msg) ->
        ...
        response =
          try do
            ...
            e ->
              ...
              Agentic.Protocol.ACP.Types.build_error(
                id,
                -32_603,
    ...
    case String.split(buffer, "\n", parts: 2) do
      [line, rest] ->
        ...
        if line == "" do
          ...
          case Agentic.Protocol.ACP.Types.parse_message(line) do
            {:ok, msg} ->
