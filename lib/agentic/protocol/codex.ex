defmodule Agentic.Protocol.Codex do
  ...
  ## Usage
      ...
      Agentic.Protocol.Registry.register(:codex, __MODULE__)

      # Use in a session
      {:ok, session_id} = Agentic.Protocol.Codex.start(config, context)
      {:ok, response} = Agentic.Protocol.Codex.send(session_id, messages, context)
  """
