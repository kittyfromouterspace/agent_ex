defmodule Agentic.Persistence.Plan.Local do
  @moduledoc """
  JSON file-based plan backend.

  Stores plans as JSON at `<workspace>/.agentic/plans/<plan_id>.json`.
  """

  @behaviour Agentic.Persistence.Plan
  ...
  defp plans_dir(workspace, opts) do
    base = Keyword.get(opts, :base_dir, ".agentic/plans")
