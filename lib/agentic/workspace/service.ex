defmodule Agentic.Workspace.Service do
  @moduledoc """
  ...
  alias Agentic.Storage.Context
  alias Agentic.Workspace.Templates
  ...
  def copy_identity_files(source_workspace_path, dest_workspace_path) do
    ...
    Enum.each(Agentic.Workspace.Identity.identity_files(), fn file ->
  ...
  def ensure_base_dir! do
    base = Agentic.Workspace.PathValidator.base_dir()
    File.mkdir_p!(base)
  end
