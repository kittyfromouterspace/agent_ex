defmodule Agentic.Subagent.Coordinator do
  @moduledoc """
  ...
  defp via(workspace) do
    {:via, Registry, {Agentic.Subagent.Registry, workspace}}
  end

  @doc "Ensure a coordinator exists for the given workspace."
  def ensure_started(workspace) do
    case Registry.lookup(Agentic.Subagent.Registry, workspace) do
      [{pid, _}] -> {:ok, pid}
      [] -> Agentic.Subagent.CoordinatorSupervisor.start_coordinator(workspace)
    end
  end
