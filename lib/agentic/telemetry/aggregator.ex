defmodule Agentic.Telemetry.Aggregator do
  @moduledoc """
  ...
  @doc false
  def handle_event([:agentic, :orchestration, :turn], _measurements, metadata, _config) do
    GenServer.cast(__MODULE__, {:turn, metadata})
  end

  def handle_event([:agentic, :orchestration, :tool_executed], measurements, metadata, _config) do
