defmodule AgentEx.Persistence.Transcript.Local do
  @moduledoc """
  JSONL file-based transcript backend.

  Writes session events as JSONL to `<workspace>/.agent_ex/sessions/<session_id>.jsonl`.
  """
  ...
  defp sessions_dir(workspace, opts) do
    base = Keyword.get(opts, :base_dir, ".agent_ex/sessions")
