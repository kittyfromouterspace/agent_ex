defmodule AgentEx.Protocol.ACP.Permission do
  @moduledoc """
  Bridges ACP permission requests to AgentEx tool permission system.

  When an ACP agent sends a `session/request_permission` request, this module
  translates between ACP's permission option model and AgentEx's `tool_permissions`
  map.
