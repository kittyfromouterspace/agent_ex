defmodule AgentEx.Protocol.ACP.Types do
  ...
  # --- Message conversion: AgentEx -> ACP ---

  @doc """
  Converts AgentEx messages to ACP ContentBlock[] format.

  AgentEx messages use `%{"role" => ..., "content" => ...}` with string keys.
  ...
  # --- Message conversion: ACP -> AgentEx ---
  ...
  # --- Tool call conversion: ACP -> AgentEx ---

  @doc """
  Converts an ACP tool_call_update to AgentEx pending_tool_call format.
  """
