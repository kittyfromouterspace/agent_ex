defmodule Agentic.Loop.Stages.ModeRouterTest do
  use ExUnit.Case, async: true

  alias Agentic.Loop.Stages.ModeRouter
  ...
  describe "max_turns safety rail" do
    test "fires when turns_used >= max_turns" do
      ctx =
        ...
        |> Map.put(:config, %{max_turns: 50, telemetry_prefix: [:agentic]})
...
defmodule Agentic.Loop.Stages.ModeRouterTelemetryTest do
