defmodule Agentic.Loop.ProfileTest do
  ...
  describe "stages/1" do
    test "agentic profile has 7 stages" do
      ...
      assert Agentic.Loop.Stages.ContextGuard in stages
      assert Agentic.Loop.Stages.ProgressInjector in stages
      assert Agentic.Loop.Stages.LLMCall in stages
      assert Agentic.Loop.Stages.ModeRouter in stages
      assert Agentic.Loop.Stages.TranscriptRecorder in stages
      assert Agentic.Loop.Stages.ToolExecutor in stages
      assert Agentic.Loop.Stages.CommitmentGate in stages
    end
    ...
    test "agentic_planned profile has 10 stages" do
      ...
      assert Agentic.Loop.Stages.WorkspaceSnapshot in stages
      assert Agentic.Loop.Stages.PlanBuilder in stages
      assert Agentic.Loop.Stages.PlanTracker in stages
      assert Agentic.Loop.Stages.ModeRouter in stages
      assert Agentic.Loop.Stages.TranscriptRecorder in stages
    end
    ...
    test "turn_by_turn profile has 8 stages" do
      ...
      assert Agentic.Loop.Stages.WorkspaceSnapshot in stages
      assert Agentic.Loop.Stages.HumanCheckpoint in stages
      assert Agentic.Loop.Stages.ModeRouter in stages
      assert Agentic.Loop.Stages.TranscriptRecorder in stages
    end
  ...
  describe "config/1" do
    test "agentic config returns valid defaults" do
      ...
      assert config.telemetry_prefix == [:agentic]
    end
