defmodule Agentic.Persistence.PlanLocalTest do
  use ExUnit.Case, async: true

  alias Agentic.Persistence.Plan.Local

  setup do
    workspace = Path.join(System.tmp_dir!(), "agentic_plan_#{:rand.uniform(999_999)}")
