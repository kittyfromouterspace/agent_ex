defmodule AgentEx.Strategy.RegistryTest do
  ...
  alias AgentEx.Strategy.Registry, as: StrategyRegistry

  setup do
    Elixir.Registry.start_link(keys: :unique, name: AgentEx.Memory.ContextKeeperRegistry)
    Elixir.Registry.start_link(keys: :unique, name: AgentEx.Subagent.Registry)
  ...
  describe "fetch/1" do
    test "returns Default for :default" do
      assert StrategyRegistry.fetch(:default) == AgentEx.Strategy.Default
    end
