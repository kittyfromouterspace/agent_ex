defmodule AgentEx.Persistence.KnowledgeLocalTest do
  use ExUnit.Case, async: true

  alias AgentEx.Persistence.Knowledge.Local

  setup do
    workspace = Path.join(System.tmp_dir!(), "agent_ex_knowledge_#{:rand.uniform(999_999)}")
