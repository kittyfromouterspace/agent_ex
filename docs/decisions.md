...
- **Source:** multi-mode-loop-proposal.md §10
...
- **Source:** multi-mode-loop-proposal.md §5.3
...
- **Source:** Ported from Homunculus ContinuationDetector patterns
...
- **Source:** Ported from Homunculus MemoryManager.optimize_context
...
- **Source:** Based on SCE semaphore pattern from Homunculus
...
- **Source:** Cache awareness design for LLM provider caching
...
- **Source:** TranscriptRecorder placement design
...
- **Source:** Based on Homunculus Coordinator pattern
...
- **Source:** Subagent nesting safety design
...
- **Source:** Tool permission model design
